package com.example.managermonster;
...
import com.example.managermonster.views.masterdetail.MasterDetailView;

/**
 * The main view is a top-level placeholder for other views.
 */
@JsModule("./styles/shared-styles.js")
@PWA(name = "Monster Manager", shortName = "Monster Manager")
